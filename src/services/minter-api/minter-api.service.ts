...
export class MinterApiService extends GetMinterApi {
  ...
  candidate(candidate: string, notShowStakes: boolean | null = null, height: number | null = null) {
    // console.log('MinterApiService candidate');
      this.minterApi.getCandidateGrpc(candidate, notShowStakes, height).then((r) => {
